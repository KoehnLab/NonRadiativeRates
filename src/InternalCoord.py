"""
Adapted/copied from the example file of molMod: 
    see https://molmod.github.io/molmod/tutorial/internal_coordinates.html
    added a __str__ method to allow printing of internal coordinate lists etc.
"""
...
class BondLength(InternalCoordinate):
    ...
    def __str__(self):
        return InternalCoordinate.__str__(self,"stre")
...
class BendingAngle(InternalCoordinate):
    ...
    def __str__(self):
        return InternalCoordinate.__str__(self,"bend")
...
class DihedralAngle(InternalCoordinate):
    ...
    def __str__(self):
        return InternalCoordinate.__str__(self,"tors")
